CREATE DATABASE  IF NOT EXISTS `db_ecom_user` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `db_ecom_user`;
-- MySQL dump 10.13  Distrib 8.0.29, for Linux (x86_64)
--
-- Host: 127.0.0.1    Database: db_ecom_user
-- ------------------------------------------------------
...
-- Dump completed on 2022-12-03 22:36:28
